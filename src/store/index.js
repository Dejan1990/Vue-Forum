...
export default createStore({
  ...
  mutations: {
    setPost (state, { post }) {
      ...
      if (post.id && index !== -1) {//index !== -1 -> the post exists at a particular index in the state
    ...
    setThread (state, { thread }) {
      ...
      if (thread.id && index !== -1) {//index !== -1 -> the post exists at a particular index in the state
